...
function togglePassword() {
    ...
    togglePW.textContent === '<i class="fa fa-eye" aria-hidden="true">' ? togglePW.textContent = '<i class="fa fa-eye-slash" aria-hidden="true"></i>' : togglePW.textContent = '<i class="fa fa-eye" aria-hidden="true">';
}
